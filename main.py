...
channel_ids = ['UCj22tfcQrWG7EMEKS0qLeEg', 'UCqwUrj10mAEsqezcItqvwEw', 'UC_vcKmg67vjMP7ciLnSxSHQ', 'UCvCyIiKSCA1fHKSCOKJyjXA', 'UCOhHO2ICt0ti9KAh-QHvttQ', 'UCEPL07qzVsOcHd3sMUws65g', 'UCFzyeVLrv5xzn2iTjnjaNTw', 'UCBStUF8ywTtgCvkpYVvi1YQ', 'UClVIlK8QHZ2PFkXF97bA0lg', 'UCXUJJNoP1QupwsYIWFXmsZg', 'UCvpfclapgcuJo0M_x65pfRw', 'UCmoX4QULJ9MB00xW4coMiOw', 'UCgoxyzvouZM-tCgsYzrYtyg', 'UCfwHP1M0AFSPqTdjzXhV0Zg', 'UCIsotCCdTjStPCLyD9iBCCQ', 'UC7eHZXheF8nVOfwB2PEslMw']
    ...
    for i in range(0, len(video_ids), 50):
        ...
        for video in response['items']:
            video_stats = dict(Title = video['snippet']['title'], Publish_Date =video['snippet']['publishedAt'],
                                        Views = video['statistics'].get('viewCount',0), Likes= video['statistics'].get('likeCount',0),
